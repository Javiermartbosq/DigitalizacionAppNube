...
<ol>
  <li>Para realizar la conexión de Firebase, se necesita acceder a la consola de Firebase con una cuenta de Firebase. 
    (https://console.firebase.google.com) y creamos un nuevo proyecto.</li>
